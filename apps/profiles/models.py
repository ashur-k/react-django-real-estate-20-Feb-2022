...
class Profile(TimeStampUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('Phone Number'), max_length=30, default='+4407447478625')
    ...
    city = models.CharField(verbose_name=_('City'), max_length=180, default='Stirling', blank=False, null=False)
